...
Use this file as the current work surface for a small project. Remove these instructions after adapting it. Keep sections compact and split out a dedicated specification only when one feature genuinely outgrows this format.
...
- Progress: [Current completed and active work.]
